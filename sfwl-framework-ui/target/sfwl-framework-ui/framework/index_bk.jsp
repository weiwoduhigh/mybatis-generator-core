							...
							<div class="portlet solid bordered light-grey">
								...
								<div class="portlet-body">
									<div id="site_statistics_loading">
										<img src="../static/res/metronic/image/loading.gif" alt="loading" />
									</div>
												...
												<div class="scroller" data-height="290px" data-always-visible="1" data-rail-visible1="1">
													<div class="row-fluid">
														<div class="span6 user-info">
															<img alt="" src="../static/res/metronic/image/avatar.png" />
															<div class="details">
																<div>
							...
							<div class="portlet">
								...
								<div class="portlet-body" id="chats">
									<div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">
										<ul class="chats">
											<li class="in">
												<img class="avatar" alt="" src="../static/res/metronic/image/avatar1.jpg" />
												<div class="message">
													<span class="arrow"></span>
											...
											<li class="out">
												<img class="avatar" alt="" src="../static/res/metronic/image/avatar2.jpg" />
												<div class="message">
													<span class="arrow"></span>
											...
											<li class="out">
												<img class="avatar" alt="" src="../static/res/metronic/image/avatar3.jpg" />
												<div class="message">
													<span class="arrow"></span>
